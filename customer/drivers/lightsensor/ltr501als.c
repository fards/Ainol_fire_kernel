...
#define MODE_ALS_ON_Range1		0x03
#define MODE_ALS_ON_Range2		0x0B 
...
static void ltr501_schedwork(struct work_struct *work)
{
	...
	case 8:
		...
		input_report_abs(input_dev, ABS_X, final_lux_val);
...
static int ltr501_dev_init(void)
{
	...
	ltr501_i2c_write_reg(0x8f, 0x03);
	...
	ltr501_i2c_write_reg(0x93, 0x00);
#if 1
	ltr501_i2c_write_reg(0x97, 0x01);
	ltr501_i2c_write_reg(0x98, 0x00);
	ltr501_i2c_write_reg(0x99, 0x00);
...
static int ltr501_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	input_set_abs_params(idev, ABS_X, 0, 64*1024, 0, 0);
