...
//Add by emdoor jim.kuang 2012-03-28 for G-Sensor Init
static struct mutex          sensor_mutex_on;
...
static void report_abs(void)
{
	...
	if((x==0)&&(y==0)&&(z==0))
	{
		mutex_lock(&sensor_mutex_on);

		result = i2c_smbus_write_byte_data(mma7660_i2c_client,MMA7660_MODE, MK_MMA7660_MODE(0, 1, 0, 0, 0, 0, 1)); 
		assert(result==0);		
