...
#include "board-m6g06-e4-ainol.h"
...
static struct axp_cfg_info axp_cfg = {
	...
	.pmu_bat_para8 = 15,	//3.7312
	.pmu_bat_para9 = 21,	//3.7664
	.pmu_bat_para10 = 35,	//3.8016
	.pmu_bat_para11 = 49,	//3.8368
	.pmu_bat_para12 = 56,	//3.8720
	.pmu_bat_para13 = 70,	//3.9424
	.pmu_bat_para14 = 81,	//4.0128
	.pmu_bat_para15 = 88,	//4.0832
	.pmu_bat_para16 = 97,	//4.1536
	.pmu_usbvol_limit = 1,
	.pmu_usbvol = 4000,
	.pmu_usbcur_limit = 0,
	.pmu_usbcur = 900,
...
static struct power_supply_info battery_data ={
	...
	.energy_full_design = 5400,		//battery capability
    .use_for_apm = 1,
};
...
#endif
#ifdef CONFIG_LITE_ON_LIGHT_SENSOR_LTR501
    {
...
static void wm8960_device_init(void)
{
    ...
    aml_set_reg32_bits(P_PAD_PULL_UP_REG0, 1, 19, 1);
     /* GPIOD_6 OUT PULL UP*/
    //aml_set_reg32_bits(P_PREG_PAD_GPIO2_EN_N, 0, 22, 1);    // mode
    //aml_set_reg32_bits(P_PREG_PAD_GPIO2_O, 1, 22, 1);  // value
    gpio_out(PAD_GPIOD_6, 1);
}
